...
<body>
    <div class="app dk" id="app">
        <div id="content" class="app-content" role="main">
            ...
            <div class="app-body">
                <div class="padding">
                    <h1 class="display-4 text-primary text-center">Artists</h1>
                    <div class="row">
                        <?php if ($result->num_rows > 0) : ?>
                        <?php while ($row = $result->fetch_assoc()) : ?>
                        <div class="col-md-4">
                            <div class="card text-center">
                                <img class="card-img-top" src="./artist/images/<?php echo $row['picture']; ?>"
                                    alt="Card image cap">
                                <div class="card-body">
                        ...
                        ?>
                                    ...
                                    <a href="artist_detail.php?id=<?php echo $row['id']; ?>"
