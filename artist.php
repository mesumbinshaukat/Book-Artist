    ...
    <div class="app dk" id="app">
        ...
        <div id="content" class="app-content white bg box-shadow-z2" role="main">
            ...
            nextSelector: 'a.jscroll-next:last'
                                    ...
                                    <a href="scroll.author.html" class="btn btn-sm white rounded jscroll-next">Show
                                        More</a>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-8 offset-md-2">
                            ...
                            <div id="search-result" class="animated fadeIn">
                                <p class="m-b-md"><strong>23</strong> <span class="text-muted">Results found for:
                                    </span><strong>Keyword</strong></p>
                                <div class="row">
                                    <div class="col-sm-6">
