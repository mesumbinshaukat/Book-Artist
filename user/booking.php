...
$tbl_booking_query = "SELECT * FROM `tbl_booking` WHERE `user_id` = '{$id}' AND `email`= '{$email}'";
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                        switch ($status) {
                                            case "pending":
                                                echo "<a class='btn btn-primary' href='pay_now.php?id={$booking_id}&email={$email}&amount={$fees}&number={$contact}&username={$username}' title='Pay Now'>Pay Now</a>";
                                                break;
                                            case "confirmed":
                            ...
                            <td>
                                ...
                                <a href="edit_booking.php" title="Edit" class="btn btn-primary"><i
